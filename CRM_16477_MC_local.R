...
solq_email <- sprintf("SELECT et4ae5__FromEmail__c, et4ae5__FromName__c, 
...
# solq_email <-sprintf("SELECT 
#                       et4ae5__Email__c,
#                       et4ae5__Contact_ID__c, Id,
#                       OwnerId,
#                       Name
...
# #                   api_type="Bulk 1.0")
# 
# email <- sf_query_bulk_v1(solq_email, object_name="et4ae5__IndividualEmailResult__c", 
